...
# Script to start the development environment (Arch Linux version)

# # Check if gnome-terminal is available (install if needed: sudo pacman -S gnome-terminal)
# if ! command -v gnome-terminal &> /dev/null; then
#     echo "❌ gnome-terminal not found. Install it with: sudo pacman -S gnome-terminal"
#     echo "   Or replace 'gnome-terminal' in this script with your preferred terminal (e.g., konsole for KDE)."
#     exit 1
# fi
